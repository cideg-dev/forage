...
const About: React.FC = () => {
  return (
    <section id="about" className="py-24 bg-slate-900 dark:bg-slate-950 text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <ScrollReveal className="lg:w-1/2 relative">
            ...
            <div className="absolute -bottom-10 -right-10 bg-yellow-500 text-slate-900 p-8 rounded-3xl shadow-2xl z-20 hidden md:block border-4 border-slate-900">
          ...
          <div className="lg:w-1/2">
            <ScrollReveal>
              <h2 className="text-red-500 font-bold tracking-widest uppercase mb-4">Qui Sommes-Nous ?</h2>
              <h3 className="text-4xl md:text-5xl font-black mb-8 leading-tight">
                Le Partenaire de Vos <span className="text-red-500">Succès Hydrauliques</span>
              </h3>
              
              <p className="text-slate-400 text-lg mb-8 leading-relaxed">
                Basée sur une expertise rigoureuse et un engagement total pour l'accès à l'eau, 
                <strong> ETS Docteur des Profondeurs</strong> s'est imposé comme un leader du forage mécanique et industriel.
              </p>
              ...
              <a href="#contact" className="inline-block bg-white text-slate-900 px-8 py-4 rounded-xl font-bold text-lg hover:bg-red-600 hover:text-white transition-all transform hover:-translate-y-1">
